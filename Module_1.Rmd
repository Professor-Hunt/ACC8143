...
```{r cost2 plot, echo=FALSE, eval=FALSE}
#not done

library(ggplot2)
library(hrbrthemes)

costplot2<-as.data.frame(cbind(betas,alphas,l2n2))

# Using raster
ggplot(costplot2,aes(betas, alphas)) +
  geom_raster(aes(fill = l2n2))

```

![](images/contor%20pic.png)
